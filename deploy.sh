...
# deploy to github
echo 'blog.MzMedia.com' > CNAME
if [ -z "$GITHUB_TOKEN" ]; then
  msg='deploy'
  githubUrl=git@github.com:MzMedia/blog.git
else
  msg='来自github action的自动部署'
  githubUrl=https://MzMedia:${GITHUB_TOKEN}@github.com/MzMedia/blog.git
...
# deploy to coding
# echo 'www.MzMedia.com\MzMedia.com' > CNAME  # 自定义域名
